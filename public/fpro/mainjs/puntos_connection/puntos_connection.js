...
else if(estatus == 6 || estatus == 5 || estatus == 4 || estatus == 3){
    ...
    columns: [
        ...
        { data: 'Kinya', className: 'text-center' },
        {
            ...
            "render": function(data, type, row){
                ...
                if(Estatus == 8 && row.AssociateType == 100){
                    return "Todas las semanas de promoción";
                }
                else if(Estatus == 1){
                    return "7 semanas (Nuevo influencer)";
                }   
                else if(Estatus == 8 || Estatus == 7){
                    return "7 Semanas";
                }
                else{
                    return Estatus + ' Semanas'
                }
            }
        },
